...
#define HttpStatusVaildFailed       @"验证失败！"
#define HttpStatusRequestFailed     @"请求失败！"
#define HttpStatusServerBlock       @"服务器异常！"
#define HttpStatusConncetionTimeOut @"网络超时，请重试"
#define HttpStatusPathNotFound      @"找不到地址！"
#define NotConnectNetwork           @"当前网络不可用，请检查网络"
#define SUCCESS_OPERATION           100000
#define OPERATION_SUCCESS           @"操作成功"
#define OPERATION_ERROR             @"请求异常,请重新尝试"
#define kLoadingMesssage             @"加载中..."
