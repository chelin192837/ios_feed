...
//    NSLog(@"_status.retweetedStatus --%@",_status.retweetedStatus.text);
...
- (void)_layoutPicsWithStatus:(WBStatus *)status isRetweet:(BOOL)isRetweet {
    ...
    for (WBPicture * pic in status.pics) {
        
//        NSLog(@"status.pics--%@",pic.photoTag);
